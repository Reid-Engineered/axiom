...
describe('WorkspaceToolsPage', () => {
  it('groups the real 20 modules and reports the real four workspace goals', async () => {
    render(<NavigationProvider initialRoute={{ type: 'workspaceTools', workspaceId: 'workspace-calculus-ii' }}><WorkspaceToolsPage workspaceId="workspace-calculus-ii" /></NavigationProvider>);
